...
class TestProfiles implements ILoader<Profile> {
  ...
  static Profile test1 = new Profile("_", "Jaewon Yang",
      imageUrl: "_", description: "Test profile 1");
  static Profile test2 = new Profile("_", "Matt Urrea",
      imageUrl: "_", description: "Test profile 2");
  static Profile test3 = new Profile("_", "Woo Sek Chung",
      imageUrl: "_", description: "Test profile 3");
